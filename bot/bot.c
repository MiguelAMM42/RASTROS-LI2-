...
int valor(ESTADO *e) {
    ...
    else if (d1 == 100) { // Impossível chegar à casa do jogador 1
        if (d2 > 5) valor -= 100 + d2;
        else valor -= 100 - d2;
    }
    else if (d2 == 100) { // Impossível chegar à casa do jogador 2
        if (d1 > 5) valor = 100 + d1;
        else valor = 100 - d1;
    }
    else if (d2 == 1 && get_jogador_atual(e) == 2) valor = -200; // Jogador 2 ganha
    else if (d1 == 1 && get_jogador_atual(e) == 1) valor = 200;  // Jogador 1 ganha
    else if (get_num_jogadas(e) < 3) {
        if (d2 > d1) valor -= 50 + d2;
        else if (d1 < d2) valor = 50 + d1;
    } else {
        if (d2 > d1) valor = 50 + d2;
        else if (d1 < d2) valor -= 50 + d1;
